...
export const products: Product[] = [
  ...
  },
  {
    ...
    level: "brand",
    aliases: ["nyx", "nyx makeup", "nyx lipstick"],
  },
  {
    ...
    level: "brand",
    aliases: ["urban decay", "urban decay palette", "naked palette", "vice palette"],
  },
  {
  ...
  },
  {
    ...
    brand: "NYX",
    category: "Beauty & Makeup",
    imageUrl: img("NYX Butter Gloss"),
    level: "product",
    aliases: ["nyx butter gloss", "nyx lip gloss", "nyx gloss"],
  },
  {
    ...
    brand: "NYX",
    category: "Beauty & Makeup",
    imageUrl: img("NYX Soft Matte Lip Cream"),
    level: "product",
    aliases: ["nyx soft matte lip cream", "nyx matte lip", "nyx lip cream"],
  },
  {
    id: "nyx-hd-foundation",
    slug: "nyx-hd-foundation",
    name: "HD Foundation",
    brand: "NYX",
    category: "Beauty & Makeup",
    imageUrl: img("NYX HD Foundation"),
    level: "product",
    aliases: ["nyx foundation", "nyx hd foundation", "nyx hd photogenic"],
  },
  {
    id: "urban-decay-perversion-mascara",
    slug: "urban-decay-perversion-mascara",
    name: "Perversion Mascara",
    brand: "Urban Decay",
    category: "Beauty & Makeup",
    imageUrl: img("Urban Decay Perversion Mascara"),
    level: "product",
    aliases: ["urban decay perversion mascara", "urban decay mascara", "perversion mascara"],
  },
  {
    id: "urban-decay-vice-lipstick",
    slug: "urban-decay-vice-lipstick",
    name: "Vice Lipstick",
    brand: "Urban Decay",
    category: "Beauty & Makeup",
    imageUrl: img("Urban Decay Vice Lipstick"),
    level: "product",
    aliases: ["urban decay vice lipstick", "urban decay lipstick", "vice lipstick"],
  },
  {
    id: "urban-decay-stay-naked-foundation",
    slug: "urban-decay-stay-naked-foundation",
    name: "Stay Naked Foundation",
    brand: "Urban Decay",
    category: "Beauty & Makeup",
    imageUrl: img("Urban Decay Stay Naked Foundation"),
    level: "product",
    aliases: ["urban decay stay naked foundation", "urban decay foundation", "stay naked"],
  },
  {
    id: "pacifica-crystal-spray-fragrance",
    slug: "pacifica-crystal-spray-fragrance",
    name: "Crystal Spray Fragrance (Aromapower line)",
    brand: "Pacifica",
    category: "Beauty & Fragrance",
    imageUrl: img("Pacifica Crystal Spray Fragrance"),
    level: "product",
    aliases: [
      "pacifica perfume",
      "pacifica aromapower",
      "pacifica crystal spray",
      "pacifica fragrance",
    ],
  },
  {
    id: "moon-juice-cosmic-cream",
    slug: "moon-juice-cosmic-cream",
    name: "Cosmic Cream",
    brand: "Moon Juice",
    category: "Supplements",
    imageUrl: img("Moon Juice Cosmic Cream"),
    level: "product",
...
export const associations: Association[] = [
  ...
  {
    id: "assoc-nyx-butter-gloss",
    productId: "nyx-butter-gloss",
    claimText:
      "Named after Nyx, the Greek goddess of the night. Confirmed by founder Toni Ko's own statements at the brand's 1999 launch.",
    sourceUrls: [
      "https://en.wikipedia.org/wiki/NYX_Cosmetics",
  ...
  {
    id: "assoc-nyx-soft-matte-lip-cream",
    productId: "nyx-soft-matte-lip-cream",
    claimText:
      "Named after Nyx, the Greek goddess of the night. Confirmed by founder Toni Ko's own statements at the brand's 1999 launch.",
    sourceUrls: [
      "https://en.wikipedia.org/wiki/NYX_Cosmetics",
  ...
  {
    id: "assoc-nyx-hd-foundation",
    productId: "nyx-hd-foundation",
    claimText:
      "Named after Nyx, the Greek goddess of the night. Confirmed by founder Toni Ko's own statements at the brand's 1999 launch.",
    sourceUrls: [
      "https://en.wikipedia.org/wiki/NYX_Cosmetics",
  ...
  {
    id: "assoc-urban-decay-perversion-mascara",
    productId: "urban-decay-perversion-mascara",
    claimText:
      "Founders deliberately built the brand around dark/rebellious aesthetic choices confirmed in their own words. Product lines include \"Perversion\" mascara, \"Vice\" palettes, \"Naked\" palettes, and \"Sin\" eyeshadow. Co-founders described themselves as \"co-conspirators\" in published interviews. This is dark aesthetic branding by the founders' own choice, not a specific mythology or belief-system tie.",
    sourceUrls: [
      "https://en.wikipedia.org/wiki/Urban_Decay_(cosmetics)",
  ...
  {
    id: "assoc-urban-decay-vice-lipstick",
    productId: "urban-decay-vice-lipstick",
    claimText:
      "Founders deliberately built the brand around dark/rebellious aesthetic choices confirmed in their own words. Product lines include \"Perversion\" mascara, \"Vice\" palettes, \"Naked\" palettes, and \"Sin\" eyeshadow. Co-founders described themselves as \"co-conspirators\" in published interviews. This is dark aesthetic branding by the founders' own choice, not a specific mythology or belief-system tie.",
    sourceUrls: [
      "https://en.wikipedia.org/wiki/Urban_Decay_(cosmetics)",
  ...
  {
    id: "assoc-urban-decay-stay-naked-foundation",
    productId: "urban-decay-stay-naked-foundation",
    claimText:
      "Founders deliberately built the brand around dark/rebellious aesthetic choices confirmed in their own words. Product lines include \"Perversion\" mascara, \"Vice\" palettes, \"Naked\" palettes, and \"Sin\" eyeshadow. Co-founders described themselves as \"co-conspirators\" in published interviews. This is dark aesthetic branding by the founders' own choice, not a specific mythology or belief-system tie.",
    sourceUrls: [
      "https://en.wikipedia.org/wiki/Urban_Decay_(cosmetics)",
  ...
  {
    id: "assoc-pacifica-crystal-spray-fragrance",
    productId: "pacifica-crystal-spray-fragrance",
    claimText:
      "Entire product line is built around named crystals with stated metaphysical properties (rose quartz for \"joy,\" amethyst for \"dream state,\" peridot for \"balance and control your thoughts\"). Marketing copy: \"Call in your crystal super power. Crystal-infused and plant-powered.\"",
    sourceUrls: [
      "https://www.pacificabeauty.com/collections/aromapower",
  ...
  {
    id: "assoc-moon-juice-cosmic-cream",
    productId: "moon-juice-cosmic-cream",
    claimText:
      "Founder Amanda Chantal Bacon describes the company as \"a cosmic beacon\" in her own interviews, references astrology and crystal energy throughout the brand's marketing, and publicly stated of a stolen store crystal, \"You do not want the energy of a stolen crystal.\" Company's own marketing describes Moon Juice as \"a healing force, an etheric potion, a cosmic beacon.\"",
    sourceUrls: [
      "https://www.theguardian.com/lifeandstyle/2015/jan/16/moon-juice-food-for-beautiful-people",
...
export const productAlternativeMap: ProductAlternativeMapEntry[] = [
  ...
  // Product-level entries: same alt-cbc-* rows already mapped as secondary
  // on the brand-level products above, reused here as the primary swap for
  // their own specific-SKU result card.
  { productId: "nyx-butter-gloss", alternativeId: "alt-cbc-divine-shine-lip-gloss", rank: "primary" },
  { productId: "nyx-soft-matte-lip-cream", alternativeId: "alt-cbc-velvet-lips-lipstick", rank: "primary" },
  { productId: "nyx-hd-foundation", alternativeId: "alt-cbc-tallow-cream-foundation", rank: "primary" },
  { productId: "urban-decay-perversion-mascara", alternativeId: "alt-cbc-lash-stop-mascara", rank: "primary" },
  { productId: "urban-decay-vice-lipstick", alternativeId: "alt-cbc-velvet-lips-lipstick", rank: "primary" },
